const obj = [
	...
	{
		id: 16,
		title: "Women's Moto Biker Jacket",
		price: 29.95,
		description:
...
for (let i = 0; i < options.length; i++) {
	...
	options[i].addEventListener("click", () => {
        ...
        <div class="card-content">
          ...
          <p class="card-description">${obj[k].description.slice(
						0,
						80
					)}}<span title="${obj[k].description}" id="description">...</span></p>
		  <div class="card-main">
