	...
	cardContainer.innerHTML += `
     <div class="card" id="show">
        ...
        <div class="card-content">
          ...
          <h3 class="card-title">${i.title.slice(0, 40)}</h3>
          <p class="card-description">${i.description.slice(
						0,
						60
					)}<span title="${i.description}" id="description">...</span></p>
          <hr />
		  <div class="card-main">
...
for (let i = 0; i < options.length; i++) {
	...
	options[i].addEventListener("click", () => {
		...
		if (options[i].innerText.toLowerCase() == filterCategories[i]) {
			for (const d of obj) {
				if (d.category.toLowerCase() == filterCategories[i]) {
					cardContainer.innerHTML += `<div class="card">
        <div class="img">
          <img src="${d.image}" />
        </div>
        <div class="card-content">
          <h5 id="category">${d.category}</h5>
          <h3 class="card-title">${d.title.slice(0, 40)}</h3>
          <p class="card-description">${d.description.slice(
						0,
						60
					)}<span title="${d.description}" id="description">...</span></p>
          <hr />
		  <div class="card-main">
